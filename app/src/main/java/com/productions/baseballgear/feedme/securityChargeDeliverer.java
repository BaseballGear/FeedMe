 ...
 */
public class securityChargeDeliverer extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.sec_charge_deliverer);
    ...
    private void launchPayPalPayment()
    {
        ...
        Intent intent = new Intent(securityChargeDeliverer.this, PaymentActivity.class);
    ...
    private void findCustomers()
    {
        ...
        emailAlert.setMessage("Ready to begin?")
                .setPositiveButton("Yes, show me the request", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        Intent i = new Intent(securityChargeDeliverer.this, customerRequest.class);
                        startActivity(i);
